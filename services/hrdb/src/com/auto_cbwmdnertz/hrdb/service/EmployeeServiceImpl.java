...
package com.auto_cbwmdnertz.hrdb.service;
...
import com.auto_cbwmdnertz.hrdb.Employee;
import com.auto_cbwmdnertz.hrdb.Vacation;
...
public class EmployeeServiceImpl implements EmployeeService {
	...
	public Employee update(Employee employee) throws EntityNotFoundException {
        ...
        if(employee.getEmployeesForManagerId() != null && Hibernate.isInitialized(employee.getEmployeesForManagerId())) {
            for(Employee _employee : employee.getEmployeesForManagerId()) {
                _employee.setEmployeeByManagerId(employee);
            }
        }
        if(employee.getVacations() != null && Hibernate.isInitialized(employee.getVacations())) {
